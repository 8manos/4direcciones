  ...
  <a class="ic-close" href="#" id="trigger-menu-close"></a> 
    ...
    <article class="cont_proy">
      <ul id="list_proy"><!--ORDENAR PROYECTOS ASÍ: AÑO-P-P-AÑO-P-P // POR FAVOR INGRESARLOS DE MAYOR A MENOR :)-->
        ...
        <li class="hexagon cat_3" style="background-image:url(images/misc/galeria/PROY-3.png);" onClick="prueba()">
          <div class="hexagon_hov">
            <p>Maxi: Guardián de las anacondas</p>
          </div>
          <div class="face1"></div>
        ...
        <li class="hexagon cat_4" style="background-image:url(images/misc/galeria/PROY-4.png);" onClick="prueba()" >
          <div class="hexagon_hov">
            <p>Maxi: Guardián de las anacondas</p>
          </div>
          <div class="face1"></div>
        ...
        <li class="hexagon cat_3" style="background-image:url(images/misc/galeria/PROY-7.png);" onClick="prueba()" >
          <div class="hexagon_hov">
            <p>Maxi: Guardián de las anacondas</p>
          </div>
          <div class="face1"></div>
